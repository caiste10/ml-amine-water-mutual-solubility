...
DATA_PATH = BASE_DIR.parent / "datasets" / "water_in_amine_processed.xlsx"
...
# ============================================================
# 5. BASE MODEL 2: CatBoost (OPTIMIZED)
# ============================================================
...
# ============================================================
# 7. 10-FOLD CROSS-VALIDATION (STACKING)
# ============================================================
cv = KFold(
    n_splits=10,
    shuffle=True,
...
print("\n" + "=" * 60)
print("FINAL STACKING MODEL: SVR + CatBoost")
